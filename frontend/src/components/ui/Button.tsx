...
const buttonVariants = cva(
  [
    ...
    "disabled:pointer-events-none disabled:bg-gray-300 disabled:text-white disabled:shadow-none",
    "active:scale-95",
  ],
  {
    variants: {
      variant: {
        ...
        link: ["text-kkookk-orange-500 underline-offset-4", "hover:underline"],
        subtle: [
