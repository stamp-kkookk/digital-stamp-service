...
│   ├── domain/
│   │   └── OwnerAccount.java           # Entity (table: owner_account, admin boolean)
│   ├── repository/
...
└── global/
    ...
    └── util/
        ...
        └── PhoneValidator.java         # 전화번호 유효성 검증
```
...
| ADMIN_ACCESS_DENIED | 403 | ADMIN_ACCESS_DENIED | 관리자 접근 권한이 없습니다 | admin=false인 Owner가 /api/admin/** 접근 |
